...
def read_data_from_csv_file(fileName_train, fileName_test, max_num_problems):
    ...
    n=int(len(rows))
    print('line 36:n=',n)#line 36:n= 10083
...
args.test_data_path= "./data/val.csv"
